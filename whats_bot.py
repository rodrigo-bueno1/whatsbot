...
class zapbot:
    ...
    def envia_msg(self, msg):
        ...
        try:
            ...
            self.caixa_de_mensagem = self.driver.find_element_by_class_name("_2S1VP").find_element_by_xpath("//div[@data-tab='1']")

            # self.driver.find_element_by_xpath("//div[@data-tab='1']")
    ...
    def abre_conversa(self, contato):
        ...
        try:
            ...
            # self.caixa_de_pesquisa = self.driver.find_element_by_class_name("OUeyt")
            ...
            # self.contato = self.driver.find_element_by_class_name("OUeyt")





            # while len(self.driver.find_element_by_xpath("//span[@class='OUeyt']")):
            #     print("Ta no while")
            # else:
            #     print("Saiu do While")
            ...
            self.contato = self.driver.find_element_by_xpath("//span[@class='OUeyt']/ancestor::div[3]")
            # Entra na conversa
            self.contato.click()
        except Exception as e:
            raise e
...
bot = zapbot()
bot.abre_conversa("+55 51 8040-3522")
